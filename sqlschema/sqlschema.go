...
func CreateTables(){
	...
	rescreate, errcreate := db.Query(""+
		...
		"CREATE TABLE model(id SERIAL PRIMARY KEY, libelle VARCHAR(20), "+
	...
	_, erreur := db.Query("INSERT INTO model(libelle, marque) VALUES( 'Cabriolet', 1),"+
	...
	"( 'Serie 5', 2),( 'Serie 6', 2),( 'Serie 7', 2),( 'Serie 8', 2)"+ // Fin Modèls BMW 
	",( 'C1', 3),( 'C15', 3),( 'C2', 3),( 'C25', 3),( 'C25D', 3),( 'C25E', 3),( 'C25TD', 3),( 'C3', 3),( 'C3 Aircross', 3),( 'C3 Picasso', 3),"+
	"( 'C4 Picasso', 3),( 'C5', 3),( 'C6', 3),( 'C8', 3),( 'Ds3', 3),( 'Ds4', 3),( 'Ds5', 3);") // Fin Modèls Citroen
